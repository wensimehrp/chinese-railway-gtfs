...
中国铁路时刻表（GTFS 格式）。本仓库发布的 GTFS 仅覆盖中国国家铁路公司的铁路、
车次、车站，且仅包括线路走向、车站名称与坐标、列车时刻。不包含如无障碍设施、车票
费用的其他信息。
...
regulations, the procedure used to fetch the data will not be open-sourced.
